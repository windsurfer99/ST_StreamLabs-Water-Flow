...
You can either use the traditional cut-and-paste method or integration with GitHub and provided it to the SmartThings IDE. For additional information, some suggested documentation includes
...
* etc
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTEzNDc0NTkzLC00ODk3MjgzNzUsNjM5OD
