...
### Install API Key
After installing the Device Handler and Service Manager and then receiving the key from StreamLabs, it must be entered into the Service Manager.  In the SmartThings IDE, select the "StreamLabs Water Flo
### Prerequisites
...
* etc
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTg5NDM5NTMxLC0xODUyNzY2NDcsLTQ4OT
